  ...
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <p>
        ...
        subscription plans. By accessing or using ResumeAI (&quot;the
        Service&quot;), you agree to be bound by these Terms. If you do not
        agree to these Terms, do not use the Service.
      </p>
      <h2 className="text-xl font-semibold">1. Overview</h2>
      <p>
        ResumeAI is a SaaS platform that provides resume-building tools
      ...
      <ul className="list-inside list-disc">
        ...
        <li>
          <strong>Refund Policy:</strong> ResumeAI does not offer
      ...
      <p>
        ResumeAI grants you a limited, non-exclusive, non-transferable,
      ...
      <p>
        ...
        Resume Builder are owned by ResumeAI or its licensors. You
        agree not to infringe on these rights.
      </p>
      <h2 className="text-xl font-semibold">10. User Content</h2>
      <p>
        By using the Service, you grant ResumeAI a non-exclusive,
      ...
      <p>
        ...
        services (e.g., Stripe for payments). ResumeAI is not
      ...
      <p>
        ...
        available&quot; basis. ResumeAI makes no warranties, express or
      ...
      <p>
        To the fullest extent permitted by law, ResumeAI shall not be
      ...
      <p>
        By using ResumeAI, you acknowledge that you have read,
